...
$configurations = [
    "elementor" => ["Waterfall_Reviews\Views\Elementor\Reviews"],
    "enqueue" => [
        [
            "handle" => "wfr-style",
            "src" => WFR_URI . "assets/css/waterfall-reviews.min.css",
        ],
        [
            "handle" => "wfr-chart",
            "src" => WFR_URI . "assets/js/vendor/chart.min.js",
            "action" => "register",
        ],
        [
            "handle" => "wfr-admin",
            "src" => WFR_URI . "assets/js/wfr-admin.min.js",
            "context" => "admin",
        ],
        [
            "handle" => "wfr-scripts",
            ...
            "name" => "wfr",
            "src" => WFR_URI . "assets/js/waterfall-reviews.min.js",
        ],
    ],
    "register" => [
        "post_types" => [
        ...
        "taxonomies" => [
            ...
            [
                ...
                "args" => [
                    ...
                    "rewrite" => [
                        "hierarchical" => false,
                        "slug" => _x("reviews/tag", "Reviews Tag Slug", "wfr"),
                        "with_front" => false,
                        "show_admin_column" => true,
                    ],
                    "show_admin_column" => true,
