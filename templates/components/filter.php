...
<form class="wfr-filter <?php if($filter['instant']) { echo 'wfr-instant-filter'; } ?>" data-category="<?php echo $filter['category']; ?>" data-target="<?php echo $filter['target']; ?>">
    ...
    <?php if( $filter['sort'] ) { ?>
        <p class="wfr-filter-sort wfr-filter-field">
            <?php if( $filter['sortLabel'] ) { ?> 
                <label for="sort"><?php echo $filter['sortLabel']; ?></label>
            <?php } ?>
    ...
    <?php if( $filter['search'] ) { ?>
        <p class="wfr-filter-search wfr-filter-field">
            <?php if( $filter['searchLabel'] ) { ?> 
                <label for="search"><?php echo $filter['searchLabel']; ?></label>
            <?php } ?>            
    ...
    <?php if( $filter['price'] ) { ?>
        <p class="wfr-filter-price wfr-filter-field">
            <?php if( $filter['priceLabel'] ) { ?> 
                <label for="price"><?php echo $filter['priceLabel']; ?></label>
            <?php } ?>
    ...
    <?php if( $filter['rating'] ) { ?>
        <p class="wfr-filter-rating wfr-filter-field">
            <label for="rating"><?php echo $filter['ratingLabel']; ?></label>
            ...
            <?php } else { ?>
                <input name="rating" type="range" min="1" max="<?php echo $filter['ratingMax']; ?>" value="<?php echo $filter['ratingMin']; ?>" data-style="<?php echo $filter['ratingStyle']; ?>" />
                <span class="wfr-range-value"><?php echo $filter['ratingMin']; ?></span>
            <?php } ?>
        </p>
    <?php } ?> 
    ...
    <?php if( $filter['taxonomy'] && $filter['terms'] ) { ?>
        <p class="wfr-filter-taxonomy wfr-filter-field">
            <?php if( $filter['taxonomyLabel'] ) { ?> 
                <label for="term"><?php echo $filter['taxonomyLabel']; ?></label>
            <?php } ?>
